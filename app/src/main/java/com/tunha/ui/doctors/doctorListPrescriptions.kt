...
class doctorListPrescriptions : Fragment() {
    ...
    override fun onCreateView(
       ...
       var rootView=inflater.inflate(R.layout.fragment_doctor_list_prescriptions, container, false)
    ...
    private fun feedPrescriptions(rootView: View, sach: String) {
        ...
        val parentLinearLayout = rootView.findViewById<LinearLayout>(R.id.holdData)
        ...
        var query = myRef.orderByChild("doctor").equalTo(ids)
